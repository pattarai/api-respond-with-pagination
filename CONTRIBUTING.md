...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/api-respond-with-pagination/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/api-respond-with-pagination/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/api-respond-with-pagination.git
